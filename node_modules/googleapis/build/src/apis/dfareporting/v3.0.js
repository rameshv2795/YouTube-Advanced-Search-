...
var Resource$Advertiserlandingpages = /** @class */ (function () {
    function Resource$Advertiserlandingpages(root) {
        this.root = root;
        this.getRoot.bind(this);
    }
    Resource$Advertiserlandingpages.prototype.getRoot = function () {
        return this.root;
    };
    Resource$Advertiserlandingpages.prototype.get = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
    ...
    Resource$Advertiserlandingpages.prototype.insert = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
    ...
    Resource$Advertiserlandingpages.prototype.list = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
    ...
    Resource$Advertiserlandingpages.prototype.patch = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
    ...
    Resource$Advertiserlandingpages.prototype.update = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
...
exports.Resource$Advertiserlandingpages = Resource$Advertiserlandingpages;
...
var Resource$Cities = /** @class */ (function () {
    ...
    Resource$Cities.prototype.list = function (params, options, callback) {
        ...
        var parameters = {
            options: Object.assign({
                url: (rootUrl + '/dfareporting/v3.0/userprofiles/{profileId}/cities')
                    .replace(/([^:]\/)\/+/g, '$1'),
                method: 'GET'
            }, options),
            params: params,
...
var Resource$Files = /** @class */ (function () {
    ...
    Resource$Files.prototype.list = function (params, options, callback) {
        ...
        var parameters = {
            options: Object.assign({
                url: (rootUrl + '/dfareporting/v3.0/userprofiles/{profileId}/files')
                    .replace(/([^:]\/)\/+/g, '$1'),
                method: 'GET'
            }, options),
            params: params,
...
var Resource$Metros = /** @class */ (function () {
    ...
    Resource$Metros.prototype.list = function (params, options, callback) {
        ...
        var parameters = {
            options: Object.assign({
                url: (rootUrl + '/dfareporting/v3.0/userprofiles/{profileId}/metros')
                    .replace(/([^:]\/)\/+/g, '$1'),
                method: 'GET'
            }, options),
            params: params,
...
var Resource$Sites = /** @class */ (function () {
    ...
    Resource$Sites.prototype.insert = function (params, options, callback) {
        ...
        var parameters = {
            options: Object.assign({
                url: (rootUrl + '/dfareporting/v3.0/userprofiles/{profileId}/sites')
                    .replace(/([^:]\/)\/+/g, '$1'),
                method: 'POST'
            }, options),
            params: params,
...
var Resource$Sizes = /** @class */ (function () {
    ...
    Resource$Sizes.prototype.insert = function (params, options, callback) {
        ...
        var parameters = {
            options: Object.assign({
                url: (rootUrl + '/dfareporting/v3.0/userprofiles/{profileId}/sizes')
                    .replace(/([^:]\/)\/+/g, '$1'),
                method: 'POST'
            }, options),
            params: params,
