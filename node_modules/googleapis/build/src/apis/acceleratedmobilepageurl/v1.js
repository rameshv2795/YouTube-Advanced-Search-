 ...
 */
var Acceleratedmobilepageurl = /** @class */ (function () {
    function Acceleratedmobilepageurl(options, google) {
        this.root = this;
    ...
    Acceleratedmobilepageurl.prototype.getRoot = function () {
        return this.root;
    };
    return Acceleratedmobilepageurl;
}());
exports.Acceleratedmobilepageurl = Acceleratedmobilepageurl;
var Resource$Ampurls = /** @class */ (function () {
    function Resource$Ampurls(root) {
        this.root = root;
        this.getRoot.bind(this);
    }
    Resource$Ampurls.prototype.getRoot = function () {
        return this.root;
    };
    Resource$Ampurls.prototype.batchGet = function (params, options, callback) {
    ...
    return Resource$Ampurls;
}());
exports.Resource$Ampurls = Resource$Ampurls;
