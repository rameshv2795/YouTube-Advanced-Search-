 ...
 */
var Streetviewpublish = /** @class */ (function () {
    ...
    Streetviewpublish.prototype.getRoot = function () {
        return this.root;
    };
    return Streetviewpublish;
}());
exports.Streetviewpublish = Streetviewpublish;
var Resource$Photo = /** @class */ (function () {
    function Resource$Photo(root) {
        this.root = root;
        this.getRoot.bind(this);
    }
    Resource$Photo.prototype.getRoot = function () {
        return this.root;
    };
    Resource$Photo.prototype.create = function (params, options, callback) {
    ...
    Resource$Photo.prototype.delete = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
    ...
    Resource$Photo.prototype.get = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
    ...
    Resource$Photo.prototype.startUpload = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
    ...
    Resource$Photo.prototype.update = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
...
exports.Resource$Photo = Resource$Photo;
var Resource$Photos = /** @class */ (function () {
    function Resource$Photos(root) {
        this.root = root;
        this.getRoot.bind(this);
    }
    Resource$Photos.prototype.getRoot = function () {
        return this.root;
    };
    Resource$Photos.prototype.batchDelete = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
    ...
    Resource$Photos.prototype.batchGet = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
    ...
    Resource$Photos.prototype.batchUpdate = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
    ...
    Resource$Photos.prototype.list = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
...
exports.Resource$Photos = Resource$Photos;
