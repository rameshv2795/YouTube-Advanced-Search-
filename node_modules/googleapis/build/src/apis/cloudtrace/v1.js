...
var Resource$Projects = /** @class */ (function () {
    ...
    Resource$Projects.prototype.patchTraces = function (params, options, callback) {
...
var Resource$Projects$Traces = /** @class */ (function () {
    ...
    Resource$Projects$Traces.prototype.get = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
    ...
    Resource$Projects$Traces.prototype.list = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
