...
var Resource$Healthchecks = /** @class */ (function () {
    ...
    Resource$Healthchecks.prototype.insert = function (params, options, callback) {
        ...
        var parameters = {
            options: Object.assign({
                url: (rootUrl + '/compute/v1/projects/{project}/global/healthChecks')
                    .replace(/([^:]\/)\/+/g, '$1'),
                method: 'POST'
            }, options),
            params: params,
...
var Resource$Projects = /** @class */ (function () {
    ...
    Resource$Projects.prototype.disableXpnResource = function (params, options, callback) {
        ...
        var parameters = {
            options: Object.assign({
                url: (rootUrl + '/compute/v1/projects/{project}/disableXpnResource')
                    .replace(/([^:]\/)\/+/g, '$1'),
                method: 'POST'
            }, options),
            params: params,
...
var Resource$Routers = /** @class */ (function () {
    ...
    Resource$Routers.prototype.aggregatedList = function (params, options, callback) {
        ...
        var parameters = {
            options: Object.assign({
                url: (rootUrl + '/compute/v1/projects/{project}/aggregated/routers')
                    .replace(/([^:]\/)\/+/g, '$1'),
                method: 'GET'
            }, options),
            params: params,
...
var Resource$Sslpolicies = /** @class */ (function () {
    ...
    Resource$Sslpolicies.prototype.insert = function (params, options, callback) {
        ...
        var parameters = {
            options: Object.assign({
                url: (rootUrl + '/compute/v1/projects/{project}/global/sslPolicies')
                    .replace(/([^:]\/)\/+/g, '$1'),
                method: 'POST'
            }, options),
            params: params,
