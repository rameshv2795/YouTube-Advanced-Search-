 ...
 */
var Playcustomapp = /** @class */ (function () {
    function Playcustomapp(options, google) {
        this.root = this;
    ...
    Playcustomapp.prototype.getRoot = function () {
        return this.root;
    };
    return Playcustomapp;
}());
...
var Resource$Accounts$Customapps = /** @class */ (function () {
    function Resource$Accounts$Customapps(root) {
        this.root = root;
        this.getRoot.bind(this);
    }
    Resource$Accounts$Customapps.prototype.getRoot = function () {
        return this.root;
    };
    Resource$Accounts$Customapps.prototype.create = function (params, options, callback) {
...
exports.Resource$Accounts$Customapps = Resource$Accounts$Customapps;
