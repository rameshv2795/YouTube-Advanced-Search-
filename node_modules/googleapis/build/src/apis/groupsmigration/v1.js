 ...
 */
var Groupsmigration = /** @class */ (function () {
    function Groupsmigration(options, google) {
        this.root = this;
    ...
    Groupsmigration.prototype.getRoot = function () {
        return this.root;
    };
    return Groupsmigration;
}());
exports.Groupsmigration = Groupsmigration;
var Resource$Archive = /** @class */ (function () {
    function Resource$Archive(root) {
        this.root = root;
        this.getRoot.bind(this);
    }
    Resource$Archive.prototype.getRoot = function () {
        return this.root;
    };
    Resource$Archive.prototype.insert = function (params, options, callback) {
...
exports.Resource$Archive = Resource$Archive;
