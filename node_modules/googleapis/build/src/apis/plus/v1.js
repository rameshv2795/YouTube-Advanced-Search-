...
var Plus = /** @class */ (function () {
    ...
    Plus.prototype.getRoot = function () {
        return this.root;
    };
    return Plus;
}());
...
var Resource$Activities = /** @class */ (function () {
    ...
    Resource$Activities.prototype.search = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
...
var Resource$People = /** @class */ (function () {
    ...
    Resource$People.prototype.search = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
