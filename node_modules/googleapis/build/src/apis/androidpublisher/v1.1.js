...
var Resource$Inapppurchases = /** @class */ (function () {
    ...
    Resource$Inapppurchases.prototype.get = function (params, options, callback) {
...
exports.Resource$Inapppurchases = Resource$Inapppurchases;
var Resource$Purchases = /** @class */ (function () {
    ...
    Resource$Purchases.prototype.cancel = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
    ...
    Resource$Purchases.prototype.get = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
