...
var Resource$Preferreddeals = /** @class */ (function () {
    function Resource$Preferreddeals(root) {
        this.root = root;
        this.getRoot.bind(this);
    }
    Resource$Preferreddeals.prototype.getRoot = function () {
        return this.root;
    };
    Resource$Preferreddeals.prototype.get = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
    ...
    Resource$Preferreddeals.prototype.list = function (params, options, callback) {
        if (typeof options === 'function') {
            callback = options;
            options = {};
        }
    ...
    return Resource$Preferreddeals;
}());
exports.Resource$Preferreddeals = Resource$Preferreddeals;
